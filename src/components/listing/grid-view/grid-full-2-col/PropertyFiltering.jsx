...
export default function PropertyFiltering() {
  ...
  const navCategory = locationState.state?.activeTab || "Rent";
  ...
  return (
    <section className="pt0 pb90 bgc-f7">
      <div className="container">
        ...
        <div className="row">
          <PaginationTwo pageCapacity={6} data={sortedFilteredData} pageNumber={pageNumber} setPageNumber={setPageNumber} />
        </div>
      </div>
    </section>
  );
