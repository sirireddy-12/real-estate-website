  ...
  const iconboxData = [
    {
      ...
      text: "Browse houses, apartments and units for sale across Australia. Find your next home today.",
    ...
    },
    {
      ...
      text: "List your property and connect with thousands of buyers actively searching in your area.",
    ...
    },
    {
      ...
      text: "Search rental listings across Melbourne, Perth, Brisbane, Sydney and more.",
